...
import com.blueprint.centromere.etl.reader.RecordReader;
import com.blueprint.centromere.etl.writer.RecordWriter;
import java.io.File;
...
public class GenericDataImportProcessor<T extends Model<?>> 
  ...
  /**
   * Runs all of the {@link com.blueprint.centromere.etl.PipelineComponent#doBefore(File, Map)} methods, 
  ...
  /**
   * Runs all of the {@link com.blueprint.centromere.etl.PipelineComponent#doOnSuccess(File, Map)} 
  ...
  /**
   * Runs all of the {@link com.blueprint.centromere.etl.PipelineComponent#doOnFailure(File, Map)}
   *    methods, and throws appropriate exceptions if problems are encountered.
   * 
   * @param file
   * @param args
