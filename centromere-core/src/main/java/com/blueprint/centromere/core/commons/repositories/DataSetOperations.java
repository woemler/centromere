 ...
 * @author woemler
 */
public interface DataSetOperations<T extends DataSet<ID>, ID extends Serializable> {
	<S extends DataFile<I>, I extends Serializable> T findByDataFileId(I dataFileId);
}
