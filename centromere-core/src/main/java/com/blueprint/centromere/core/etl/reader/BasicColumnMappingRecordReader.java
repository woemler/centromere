 ...
 *   column values to {@link Model} fields.  Uses Spring's 
 *   {@link org.springframework.beans.BeanWrapper} and {@link ConversionService} to handle the text 
...
public class BasicColumnMappingRecordReader<T extends Model<?>>
    ...
    /**
     * Converts a string value from a parsed file to the appropriate type required for the 
     *   {@link Model} field.  Throws an exception if conversion cannot be applied.
     *
