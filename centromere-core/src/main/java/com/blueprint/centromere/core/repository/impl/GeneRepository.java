 ...
 */
@ModelResource("gene")
public interface GeneRepository extends ModelRepository<Gene, String>, MetadataOperations<Gene>, 
    AttributeOperations<Gene>, GuessOperations<Gene> {

	Optional<Gene> findByGeneId(@Param("geneId") String geneId);
	List<Gene> findBySymbol(@Param("symbol") String symbol);
  List<Gene> findByReferenceId(String referenceId);
