...
public class GeneValidator implements Validator {
    ...
    ValidationUtils.rejectIfEmptyOrWhitespace(errors, "dataSetId", "dataSetId.empty");
    ValidationUtils.rejectIfEmptyOrWhitespace(errors, "dataSourceId", "dataSourceId.empty");
