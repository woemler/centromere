...
import com.blueprint.centromere.core.dataimport.impl.support.SampleAware;
...
public abstract class CommonsDataProcessor<T extends Model<?>> extends GenericRecordProcessor<T> {
    ...
    public void doBefore(Object... args) throws DataImportException {
        ...
        dataSet = dataSetRepository.findOneByShortName(dataSetName);
        if (dataSet == null){
            dataSet = new DataSet();
            dataSet.setShortName(dataSetName);
