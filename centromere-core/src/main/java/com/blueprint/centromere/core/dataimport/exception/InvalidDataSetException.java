 ...
 * @since 0.5.0
 */
public class InvalidDataSetException extends DataImportException {
  ...
  public InvalidDataSetException(String message, Throwable cause, boolean enableSuppression,
