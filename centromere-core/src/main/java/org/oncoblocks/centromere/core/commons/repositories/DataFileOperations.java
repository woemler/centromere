 ...
 * @author woemler
 */
public interface DataFileOperations<T extends DataFile<ID>, ID extends Serializable> {
	<S extends DataSet<I>, I extends Serializable> List<T> findByDataSetId(I dataSetId); 
}
