...
import com.blueprint.centromere.core.ws.SpringWebCustomization;
...
public class DefaultControllerTests {
	...
	public void findAllTest() throws Exception {
		mockMvc.perform(get(BASE_URL))
				...
				.andExpect(jsonPath("$._embedded.genes[0]", hasKey("id")))
				.andExpect(jsonPath("$._embedded.genes[0].id", notNullValue()));
	}
