...
import com.blueprint.centromere.core.test.mongodb.EmbeddedMongoDataSourceConfig;
...
public class MongoDefaultControllerTests {
  ...
  public void setupTest() throws Exception {
	  ...
	  Assert.isTrue(geneExpressionRepository.count() == 6);
    ...
    PersistentEntityResourceAssembler assembler = new PersistentEntityResourceAssembler(entities, projector,
	  ...
	  for (Gene gene: geneRepository.findAll()){
	    PersistentEntityResource resource = assembler.toResource(gene);
