...
/**
 * Exception handler for {@link RestException} errors. Should be implemented as {@link
...
public class RestExceptionHandler {
    ...
    /**
     * Catches a {@link RestException} thrown bt a web service controller and returns an informative
     * message.
     *
