 ...
 * @author woemler
 */
public class CustomEntrezGeneRepositoryImpl implements CustomExtendedGeneRepository {
	
	private final MongoOperations mongoOperations;

	public CustomEntrezGeneRepositoryImpl(MongoOperations mongoOperations) {
