 ...
 * @since 0.6.0
 */
public interface DataProcessor<T extends Model<?>> extends ModelSupport<T> {
  
  void doBefore() throws DataImportException;
  
  void process(File file, Map<String, Object> args) throws DataImportException;
  
  void doOnSuccess() throws DataImportException;
