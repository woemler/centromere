...
import com.blueprint.centromere.cli.dataimport.reader.StandardRecordFileReader;
...
public class EntrezGeneInfoReader extends StandardRecordFileReader<Gene>
	...
	protected Gene getRecordFromLine(String line) throws DataImportException {
		...
		Gene gene = new Gene();
		gene.setDataSetId(this.getDataSet().getDataSetId());
		gene.setDataSourceId(this.getDataSource().getDataSourceId());
