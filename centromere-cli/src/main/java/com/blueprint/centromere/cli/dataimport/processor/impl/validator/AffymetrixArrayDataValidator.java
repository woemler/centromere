...
import com.blueprint.centromere.core.model.impl.AffymetrixArrayData;
 ...
 * @author woemler
 */
public class AffymetrixArrayDataValidator implements Validator {

	@Override 
	public boolean supports(Class<?> aClass) {
		return AffymetrixArrayData.class.isAssignableFrom(aClass);
	}

	@Override 
	public void validate(Object o, Errors errors) {
    AffymetrixArrayData data = (AffymetrixArrayData) o;
    ...
    if (data.getProbeSetId() == null) errors.reject("probeSetId", "probeSetId.empty");
	}
}
