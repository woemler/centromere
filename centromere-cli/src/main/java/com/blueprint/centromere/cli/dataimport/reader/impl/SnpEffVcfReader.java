...
import com.blueprint.centromere.core.util.AminoAcidConverter;
 ...
 * @since 0.5.0
 */
public class SnpEffVcfReader extends MultiRecordFileReader<Mutation> {
  ...
  protected void testFileFormat() throws InvalidDataSourceException {
    try {
