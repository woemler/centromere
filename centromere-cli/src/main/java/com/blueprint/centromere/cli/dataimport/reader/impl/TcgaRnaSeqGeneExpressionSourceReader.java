 ...
 * @since 0.4.3
 */
public class TcgaRnaSeqGeneExpressionSourceReader
		extends MultiRecordFileReader<GeneExpression>
		implements ModelSupport<GeneExpression>, SampleAware {

	private static final Logger logger = LoggerFactory.getLogger(TcgaRnaSeqGeneExpressionSourceReader.class);
	...
	public TcgaRnaSeqGeneExpressionSourceReader(
